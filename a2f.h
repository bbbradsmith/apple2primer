...
extern uint8 screen_load(uint16 sector); // load screen graphics from disk to current video write page
extern uint8 screen_load_double(uint16 sector); // extended screen_load for double video modes
